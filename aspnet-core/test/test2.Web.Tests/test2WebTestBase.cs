...
{
    public abstract class test2WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static test2WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(test2WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<test2DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<test2DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<test2DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<test2DbContext, Task<T>> func)
        {
            T result;
